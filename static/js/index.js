// 重庆均价
$.getJSON('/data/getAvg',function (avg) {
(function () {
  ...
  var data = {
    price: [
      [avg['price'][0],avg['price'][1],avg['price'][2],
        avg['price'][3],avg['price'][4],avg['price'][5],
        avg['price'][6],avg['price'][7],avg['price'][8]]
    ]
  };
  ...
  var option = {
    ...
    xAxis: {
      type: "category",
      boundaryGap: false,
        data: [avg['area'][0],avg['area'][1],avg['area'][2],
              avg['area'][3],avg['area'][4],avg['area'][5],
              avg['area'][6],avg['area'][7],avg['area'][8]],
      // 去除x坐标轴的颜色
      axisLine: {
            lineStyle: {
    ...
    series: [
      {
        ...
        roseType: "radius",
        data: [
            { value: data['num'][0], name: data['type'][0] },
